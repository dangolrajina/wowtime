        ...
        <header class="header">
            <nav class="navbar navbar-inverse navbar-fixed-top navbar-custom" role="navigation" >
                ...
                <ul class="nav navbar-nav pull-right pjax_nav" style="margin-right: 73px;">
                    ...
                    <li class="nav-item {{Request::path() == 'features' ? 'current_page_items' : ''}}">
                        <a class="nav-link" href="/features">Features</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/packages">Packages</a>
                    </li>
                    <li class="nav-item {{Request::path() == 'about-us' ? 'current_page_items' : ''}}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav navbar-nav text-center pjax_nav">
                            ...
                            <li class="nav-item {{Request::path() === '/' ? 'current_page_items' : ''}}">
                                <a class="nav-link" href="/packages">Packages</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/about-us">About Us</a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                                ...
                                <li class="nav-item {{Request::path() == 'packages' ? 'current_page_items' : ''}}">
                                    <a class="nav-link" href="/packages">Packages</a>
                                </li>
                            </ul>
                        </div>
