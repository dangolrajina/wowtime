...
<body class="page-template-pageFeature">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center ">
                            <h1 class="innerPage_title_featured" style="margin-top:0;padding-top:0;">WOW Packages</h1>
                        </div>
                    </div>
                    <div class="container desktop_packages">
                        <div class="row">
                            <div class="col-md-12">
                                <div role="tabpanel">
                                    <div class="col-sm-4">
                                        <ul class="nav nav-pills brand-pills nav-stacked" role="tablist">
                                            <li role="presentation" class="brand-nav active">
                                                <a href="#tab0" aria-controls="tab0" role="tab" data-toggle="tab">
                                                    <h3 class="tab_head">WOWTIME Pack</h3>
                                                    <p>WOWTIME Subscription</p>
                                                </a>
                                            </li>
                                            <li role="presentation" class="brand-nav">
                                                <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">
                                                    <h3 class="tab_head">NT WOWTIMECombo Pack</h3>
                                                    <p>WOWTIME Subscription with NT Data</p>
                                                </a>
                                            </li>
                                            <li role="presentation" class="brand-nav">
                                                <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">
                                                    <h3 class="tab_head">NT Data Pack</h3>
                                                    <p>NT Data only for WOWTIME Access</p>
                                                </a>
                                            </li>
                                ...
                                <div class="col-sm-8">
                                    <div class="tab-content" style="overflow:hidden;">
                                        <div role="tabpanel" class="tab-pane active" id="tab0">
                                            <img src="assets/uploads/packages/a1.png" alt="">
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="tab1">
                                            <img src="assets/uploads/packages/a2.png" alt="">
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="tab2">
                                            <img src="assets/uploads/packages/a3.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container mobile_packages">
                        <div class="row">
                            <div class="col-xs-12">
                                <img src="assets/uploads/packages/a1.png" alt="" class="width-100 mg-tp-bt-20">
                                <img src="assets/uploads/packages/a2.png" alt="" class="width-100 mg-tp-bt-20">
                                <img src="assets/uploads/packages/a3.png" alt="" class="width-100 mg-tp-bt-20">
                            </div>
                        </div>
